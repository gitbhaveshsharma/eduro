...
import {
    ...
    useUpdateAttendance,
    useDeleteAttendance,
    useFetchAttendanceList,
    useFetchDailyAttendance,
    useFetchAttendanceById,
    useFetchStudentSummary,
    useFetchClassReport,
    useFetchTeacherAttendance,
    useFetchStudentAttendance,
    useFetchClassAttendance,
    useFetchBranchAttendance,
    useFetchCoachingCenterDailyAttendance,
    useFetchBranchDailyAttendance,
    useSetCurrentRecord,
    useSetAttendanceFilters,
    useResetAttendanceFilters,
    useSetAttendancePagination,
    useSetAttendanceSort,
    useClearAttendanceError,
    useClearAttendanceSuccessMessage,
    useResetAttendanceStore,
...
export {
    ...
    useAttendanceSuccessMessage,
    useDailyAttendanceStats,
    // Action hooks - individual (stable references)
    useMarkAttendance,
    useBulkMarkAttendance,
    useUpdateAttendance,
    useDeleteAttendance,
    ...
    useClearAttendanceSuccessMessage,
    useResetAttendanceStore,
    // Legacy action hooks (may cause re-renders)
    useAttendanceActions,
    // Types
