/**
 * Student Quizzes Components Index
 * 
 * Central export for all student quiz components
 * @module student/quizzes
 */

export { StudentQuizzesDashboard } from './student-quizzes-dashboard';
