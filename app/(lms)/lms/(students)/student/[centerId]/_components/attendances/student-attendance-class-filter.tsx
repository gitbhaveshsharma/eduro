/**
 * Student Attendance Class Filter Component
 * 
 * Horizontal scrollable filter pills for selecting classes
 * Similar to teacher's AttendanceClassFilter component style
...
interface StudentAttendanceClassFilterProps {
...
export function StudentAttendanceClassFilter({
    classes,
    selectedClassId,
    onClassChange,
    isLoading = false,
    showAllOption = true,
}: StudentAttendanceClassFilterProps) {
    if (isLoading) {
        return (
